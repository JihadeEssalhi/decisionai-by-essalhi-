...
import { ArrowRight, Eye, EyeOff, Lock, Mail, User, CheckCircle, ArrowLeft, XCircle } from "lucide-react";
...
export default function RegisterPage() {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (name === 'password') {
            ...
            // Vérifier la correspondance avec confirmPassword
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Le rôle sera automatiquement 'USER' via le trigger
    ...
    const getValidationIcon = (valid: boolean | null, className = 'w-4 h-4') => {
        ...
        return valid ? (
            <CheckCircle className={`${className} text-blue-400`} />
        ) : (
        ...
        <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
            ...
            <div className="relative z-10 w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 md:p-10 shadow-2xl shadow-violet-600/40">
                ...
                <div className="text-center mb-3">
                    <span className="text-xs text-white/50 font-medium tracking-[0.2em] uppercase">— Créer un compte —</span>
                </div>

                <div className="mb-8 text-center">
                    <h1 className="text-3xl font-bold text-white tracking-tight">Inscription</h1>
                    <p className="text-sm text-white/60 mt-1">Rejoignez DecisionAI et pilotez vos données</p>
                </div>
                ...
                {success ? (
                    ...
                    <form onSubmit={handleRegister} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading || !passwordValid || !passwordsMatch || !emailValid || !fullNameValid}
                ...
                <p className="mt-6 text-center text-sm text-white/50">
                    Déjà un compte ?{" "}
                    <Link href="/login" className="text-blue-400 hover:text-blue-300 transition-colors font-medium inline-flex items-center gap-1 group">
                        Se connecter
